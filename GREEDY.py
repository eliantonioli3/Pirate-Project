...
class GreedyNode(Node):
    ...
    def __lt__(self, other):
       return (self.w*self.h) < (self.w*other.h )      
...
class Greedy(SearchAlgorithm):
    ...
    def solve(self, problem) -> list:
        ...
        while goals: 
            ...
            node = GreedyNode(current_start, None, None, 0, self.heuristic(current_start, goals), self.w)
            ...
            while not frontier.empty():
                ...
                for action, statoSucc, cost in problem.getSuccessors(n.state):
                    child = GreedyNode(statoSucc, n, action, n.g + cost, self.heuristic(statoSucc, goals), self.w)  # Crea il nodo figlio
